...
class AddSectionView: UIViewController, AddSectionViewProtocol {
    var presenter: AddSectionPresenterProtocol?
    ...
    @objc func insertTapped() {
        ...
        presenter?.addCategory(name: name)
...
extension AddSectionView: UIPickerViewDataSource {
...
//MARK: - UIPickerViewDelegate
extension AddSectionView: UIPickerViewDelegate {
}
