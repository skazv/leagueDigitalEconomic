...
class AddCellView: UIViewController, AddCellViewProtocol {
    ...
    @objc func insertTapped() {
        ...
        presenter?.addPerson(name: name, section: section ?? 0)
...
extension AddCellView: UIPickerViewDataSource {
...
//MARK: - UIPickerViewDelegate
extension AddCellView: UIPickerViewDelegate {
}
